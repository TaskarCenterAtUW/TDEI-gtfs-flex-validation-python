...
class TestGTFSFlexValidation(unittest.TestCase):
    def setUp(self):
        ...
        self.validator = GTFSFlexValidation(file_path=file_path, storage_client=storage_client)

    def tearDown(self):
        pass

    def test_is_gtfs_flex_valid_valid(self):
        # Arrange
        ...
        # Act
        is_valid, _ = self.validator.is_gtfs_flex_valid()

        # Assert
        self.assertTrue(is_valid)
        gcv_test_release.test_release.assert_called_once_with('gtfs_flex', 'v2.0', 'downloaded_file_path')
        GTFSFlexValidation.clean_up.assert_called_once_with('downloaded_file_path')

    def test_is_gtfs_flex_valid_invalid(self):
        # Arrange
        self.validator.download_single_file = MagicMock(return_value='downloaded_file_path')
